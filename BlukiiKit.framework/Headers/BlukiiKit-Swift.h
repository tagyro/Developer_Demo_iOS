...
- (nonnull instancetype)initWithBlukii:(BKBlukiiDescription * __nonnull)blukii OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly, strong) CBPeripheral * __nonnull peripheral;
...
///
/// @see        determineDeviceInformation:
@property (nonatomic, readonly, strong) BKFirmwareRevision * __nullable firmwareRevision;
...
- (nonnull instancetype)initWithPeripheral:(CBPeripheral * __nonnull)peripheral OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly, strong) BKBlukiiDescription * __nonnull blukiiDescription;
...
@property (nonatomic, readonly, strong) BKBatteryServiceProfileHandler * __nullable batteryService;
...
@property (nonatomic, readonly, strong) BKServiceProfileHandler * __nullable service;
...
@property (nonatomic, readonly, strong) BKRecordingProfileHandler * __nullable recording;
...
@property (nonatomic, readonly, strong) BKAccelerometerProfileHandler * __nullable accelerometer;
...
@property (nonatomic, readonly, strong) BKTemperatureProfileHandler * __nullable temperature;
...
@property (nonatomic, readonly, strong) BKDirectometerProfileHandler * __nullable directometer;
...
@property (nonatomic, readonly, strong) BKHumidityProfileHandler * __nullable humidity;
...
@property (nonatomic, readonly, strong) BKLightProfileHandler * __nullable light;
...
@property (nonatomic, readonly, strong) BKAltimeterProfileHandler * __nullable altimeter;
...
@property (nonatomic, readonly, copy) NSArray<NSNumber *> * __nonnull revisionComponents;
...
@property (nonatomic, copy) NSArray<NSNumber *> * __nonnull _revisionComponents;
@end
